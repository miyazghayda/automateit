...
/*! jqBootstrapValidation - v1.3.8 - 2015-01-05
* http://reactiveraven.github.com/jqBootstrapValidation
* Copyright (c) 2013 David Godfrey; Licensed MIT 
* Upgraded to bootstrap 3.X by Georgie Varkey
*/
      ...
      init : function( options ) {
        ...
        return this.each(function(){
          ...
          if (!$helpBlock.length && settings.options.autoAdd && settings.options.autoAdd.helpBlocks) {
              ...
              $controlGroup.find('.form-val').append($helpBlock);
...
// jqvalidation successful form submission message
$(function () {
      $("input,select,textarea").not("[type=submit]").jqBootstrapValidation({
          preventSubmit: true,
          submitError: function ($form, event, errors) {
              // Here handle errors.we can add errors in a div 
          },
          submitSuccess: function ($form, event) {
              // Show your Success Message
              //$(".alert-wrapper").fadeIn();
              showalert("Submitted Successfully","alert alert-success");
...
// Method to dynamically add messages to the bootstrap form
